...
func (s *Server) serveAPI(w http.ResponseWriter, r *http.Request) {
	...
	case r.URL.Path == "/api/v1/settings/automatic-update" ||
...
func allowedAgentPath(publicPath string) (string, bool) {
	exact := map[string]string{
		...
		"/api/v1/system/runtime":                "/v1/system/runtime",
		"/api/v1/system/management/config":      "/v1/system/management/config",
		"/api/v1/system/management/ssh-defense": "/v1/system/management/ssh-defense",
		"/api/v1/system/management/bbrv3":       "/v1/system/management/bbrv3",
