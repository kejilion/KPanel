...
export default [
  ...
  ["请使用密码重新登录。", "Please re-enter using the password."],
  ["请使用新密码重新登录。", "Please re-enter using the new password."],
  ...
  ["账户与设备偏好。宿主机安全策略由 Agent 配置控制，不能在浏览器中放宽。", "Account and equipment preferences. The host security policy is controlled by Agent configuration and cannot be relaxed in the browser."],
  ["正常", "Healthy"],
