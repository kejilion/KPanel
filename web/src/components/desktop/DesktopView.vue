...
import { deriveThemeTokens, THEME_COLOR_PRESETS, type ThemeColorIntent } from '@/theme/colors'
...
function updateWidgetDragPreview(drag: WidgetDragState): void {
  ...
  // Follow the pointer continuously; snapping/collision belongs only to pointerup.
