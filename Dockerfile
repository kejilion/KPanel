...
LABEL org.opencontainers.image.title="KPanel" \
      ...
      io.kejilion.script.revision="6ebb945f6d5cb69fdb41e3761de23566acbaf762" \
      io.kejilion.script.sha256="28cf3934c01fe79a19c51fac520f11a2bdd7656d762f37d6fc4153140a6df549"
COPY --from=go-build /out/paneld /paneld
COPY --from=go-build /out/kejilion-agent /release/kejilion-agent
COPY --from=go-build /etc/ssl/certs/ca-certificates.crt /etc/ssl/certs/ca-certificates.crt
ADD --checksum=sha256:28cf3934c01fe79a19c51fac520f11a2bdd7656d762f37d6fc4153140a6df549 \
    https://raw.githubusercontent.com/kejilion/sh/6ebb945f6d5cb69fdb41e3761de23566acbaf762/kejilion.sh \
    /release/kejilion.sh
