...
LABEL org.opencontainers.image.title="KPanel" \
      ...
      io.kejilion.script.revision="193a29710d18421242b2d5e2358ff36543e360cf" \
      io.kejilion.script.sha256="7eb40d270323e91d12ce989ff13baa5b16f0feb53ef2906741d87eefcc3bb6d6"
COPY --from=go-build /out/paneld /paneld
COPY --from=go-build /out/kejilion-agent /release/kejilion-agent
COPY --from=go-build /etc/ssl/certs/ca-certificates.crt /etc/ssl/certs/ca-certificates.crt
ADD --checksum=sha256:7eb40d270323e91d12ce989ff13baa5b16f0feb53ef2906741d87eefcc3bb6d6 \
    https://raw.githubusercontent.com/kejilion/sh/193a29710d18421242b2d5e2358ff36543e360cf/kejilion.sh \
    /release/kejilion.sh
